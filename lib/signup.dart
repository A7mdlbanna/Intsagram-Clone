                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (value){
                          nameTapped =  true;
                          value.length > 1 ?
                          setState((){nameLabelColor = Colors.white54; validName = true; nameIcon = Icon(Icons.check_circle_outline_rounded, color: Colors.white54,); nameBorderColor = Colors.blue;})
                        : setState((){nameLabelColor = Colors.red; validName = false; nameIcon = Icon(Icons.cancel_outlined, color: Colors.red,); nameBorderColor = Colors.red;});
                        },

                        decoration:  InputDecoration(
                          suffixIcon: nameIcon,
                          labelText: 'Full Name',
                          labelStyle: TextStyle(color: nameFocus.hasFocus ? nameBorderColor : nameLabelColor),
                          focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: nameBorderColor), borderRadius: BorderRadius.all(Radius.circular(8.0)),),
                          enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: validName ? Colors.white54 : (nameTapped ? Colors.red : Colors.white54)), borderRadius: BorderRadius.all(Radius.circular(8.0)),
                          ),
                        ),
                      ),
                    ),
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (value){
                          ...
                          setState((){usernameLabelColor = Colors.white54; validUserName = true; usernameIcon = Icon(Icons.check_circle_outline_rounded, color: Colors.white54,); usernameBorderColor = Colors.blue;})
                        : setState((){usernameLabelColor = Colors.red; validUserName = false; usernameIcon = Icon(Icons.cancel_outlined, color: Colors.red,); usernameBorderColor = Colors.red;});
                        },
                        ...
                        decoration: InputDecoration(
                          ...
                          labelStyle: TextStyle(color: usernameFocus.hasFocus ? usernameBorderColor : usernameLabelColor),
                          focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: usernameBorderColor), borderRadius: BorderRadius.all(Radius.circular(8.0)),),
                          enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: validUserName ? Colors.white54 : (nameTapped ? Colors.red : Colors.white54)), borderRadius: BorderRadius.all(Radius.circular(8.0)),
                          ),
                        ),
                      ),
                    ),
                    ...
                    Container(
                       ...
                       child: MaterialButton(
                         ...
                         child: Text(
                           'Sign up',
                           style: TextStyle(
                               fontSize: 16, color: Colors.blueGrey.shade100),
                         ),
                         onPressed: isDisabledButton() ? (){} :
                             (){
                           setState(() {
                               userdataEP[_emailController.text] = _passwordController.text;
                               // widget.userinfoUP[_usernameController.text] = _passwordController.text;
                               Navigator.pop(
                                 context,
                                 userdataEP,
                               );
      ...
      bottomNavigationBar: Container(
        ...
        child: BottomAppBar(
          ...
          child: Row(
            ...
            children: [
              Text('Have an account?', style: TextStyle(color: Colors.white60, fontSize: 15),),
              TextButton(
                  onPressed: (){
                    Navigator.pop(
                      context,
                        userinfo[_emailController.text] = _passwordController.text
                        // userData: system,
                    );
                  },
                  child: Text(
